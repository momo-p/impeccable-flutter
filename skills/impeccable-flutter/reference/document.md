...
## Color
Seed, the roles overridden and why, the dark scheme's status, any color
living outside the theme and where.

## Type
Family, source, the roles with their values, the scale ratio, where
screens depart from the roles.

## Spacing and shape
The step scale in use, corner radii, elevation approach (tonal or shadow).
